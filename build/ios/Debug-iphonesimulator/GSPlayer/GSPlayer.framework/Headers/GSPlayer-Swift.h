...
#ifndef GSPLAYER_SWIFT_H
#define GSPLAYER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GSPlayer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8GSPlayer25VideoFullscreenPlayerView")
...
SWIFT_CLASS("_TtC8GSPlayer27VideoFullscreenTransitioner")
...
@interface VideoFullscreenTransitioner (SWIFT_EXTENSION(GSPlayer)) <UIViewControllerTransitioningDelegate>
...
@interface VideoFullscreenTransitioner (SWIFT_EXTENSION(GSPlayer)) <UIViewControllerAnimatedTransitioning>
...
SWIFT_CLASS("_TtC8GSPlayer16VideoLoadManager")
...
@interface VideoLoadManager (SWIFT_EXTENSION(GSPlayer)) <AVAssetResourceLoaderDelegate>
...
SWIFT_CLASS("_TtC8GSPlayer15VideoPlayerView")
...
@interface VideoPlayerView (SWIFT_EXTENSION(GSPlayer))
...
SWIFT_CLASS("_TtC8GSPlayer19VideoPreloadManager")
